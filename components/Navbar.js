...
const Navbar = () => {
    ...
    return (
        <>
            {showNavbar && (
                <nav className="bg-white fixed top-4 md:top-10 left-1/2 -translate-x-1/2 
                                w-[95vw] md:w-[85vw] lg:w-[80vw]
                                flex items-center justify-between
                                rounded-full px-4 md:px-7 py-3 md:py-5 shadow-md z-50">
                    ...
                    <div className="flex gap-2 md:gap-3">
                        <button className="bg-gray-400 px-3 py-2 md:px-4 md:py-3 rounded-lg font-bold">
                            Log in
                        </button>
                        <button className="bg-gray-900 text-white font-bold px-4 py-2 md:px-5 md:py-3 rounded-full">
                            Sign up free
                        </button>
                    </div>
                </nav>
